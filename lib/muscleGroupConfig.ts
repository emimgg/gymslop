import {
  ...
  Activity, Flame, PersonStanding, Weight, Heart, ChevronsUp,
} from 'lucide-react';
import type React from 'react';

export type NeonColor = 'cyan' | 'green' | 'yellow' | 'pink' | 'purple' | 'orange' | 'red' | 'blue' | 'teal';
...
export const MG_CONFIG: Record<string, MgConfig> = {
  ...
  TRAPS:      { color: 'teal',   Icon: ChevronsUp,     labelKey: 'muscle.TRAPS',      order: 3  },
  NECK:       { color: 'pink',   Icon: Activity,       labelKey: 'muscle.NECK',       order: 4  },
...
export const COLOR_STYLES: Record<NeonColor, {
  ...
  teal:   { text: 'text-neon-teal',   border: 'border-neon-teal/40',   bg: 'bg-neon-teal/10',   headerBg: 'bg-neon-teal/5',   badge: 'bg-neon-teal/15 text-neon-teal border border-neon-teal/30',     dot: 'bg-neon-teal'   },
};
