...
async function main() {
  ...
  const foods = [
    // Carnes blancas — USDA raw values
    { name: 'Pechuga de Pollo',   calories: 110,  protein: 22,   carbs: 0,    fat: 2.5,  fiber: 0,    serving: 100, searchTerms: 'chicken breast,pollo,pechuga,chicken,pollito,pollo crudo' },
    { name: 'Muslo de Pollo',     calories: 177,  protein: 17,   carbs: 0,    fat: 12,   fiber: 0,    serving: 100, searchTerms: 'chicken thigh,muslo,muslo de pollo,pollo,chicken,dark meat' },
    { name: 'Ground Beef (lean)', calories: 152,  protein: 17,   carbs: 0,    fat: 9,    fiber: 0,    serving: 100, searchTerms: 'ground beef,carne molida,res molida,picada,carne picada,beef,hamburguesa,carne' },
    // Pescados — USDA raw values
    { name: 'Salmón',             calories: 142,  protein: 20,   carbs: 0,    fat: 6,    fiber: 0,    serving: 100, searchTerms: 'salmon,salmón,fish,pescado,atlantic salmon' },
    { name: 'Tuna (canned in water)', calories: 116, protein: 25, carbs: 0,   fat: 1,    fiber: 0,    serving: 100, searchTerms: 'tuna,atun,atún,lata de atun,canned tuna,fish,pescado,tuna can' },
    { name: 'Tilapia',            calories: 96,   protein: 20,   carbs: 0,    fat: 2,    fiber: 0,    serving: 100, searchTerms: 'tilapia,fish,pescado' },
    { name: 'Camarón',            calories: 85,   protein: 18,   carbs: 0.9,  fat: 1,    fiber: 0,    serving: 100, searchTerms: 'shrimp,camarones,camarón,gambas,prawn' },
    // Huevos — USDA raw values
    { name: 'Egg (whole)',        calories: 143,  protein: 13,   carbs: 1,    fat: 10,   fiber: 0,    serving: 100, searchTerms: 'egg,huevo,huevo entero,whole egg,huevo crudo' },
    { name: 'Egg White',          calories: 52,   protein: 11,   carbs: 1,    fat: 0,    fiber: 0,    serving: 100, searchTerms: 'egg white,clara de huevo,claras,clara,egg whites' },
    // Lácteos
    { name: 'Greek Yogurt (plain 0%)', calories: 59, protein: 10, carbs: 3.6, fat: 0.4,  fiber: 0,    serving: 100, searchTerms: 'greek yogurt,yogur griego,yogurt griego,yogur,yogurt,yogur natural' },
    { name: 'Cottage Cheese',     calories: 98,   protein: 11,   carbs: 3.4,  fat: 4.3,  fiber: 0,    serving: 100, searchTerms: 'cottage cheese,queso cottage,queso blanco' },
    { name: 'Whey Protein Powder',calories: 370,  protein: 80,   carbs: 6,    fat: 4,    fiber: 0,    serving: 100, searchTerms: 'whey,proteina,proteína,protein powder,suero de leche,whey protein,proteina de suero' },
    // Carbohidratos — raw values
    { name: 'Arroz Blanco',       calories: 394,  protein: 8.2,  carbs: 84.8, fat: 0.9,  fiber: 1.2,  serving: 100, searchTerms: 'white rice,arroz blanco,arroz,rice,arroz crudo' },
    { name: 'Arroz Integral',     calories: 336,  protein: 7.9,  carbs: 69.7, fat: 2.7,  fiber: 5.5,  serving: 100, searchTerms: 'brown rice,arroz integral,arroz,rice,integral' },
    { name: 'Avena',              calories: 389,  protein: 17,   carbs: 66,   fat: 7,    fiber: 10.6, serving: 100, searchTerms: 'oats,avena,oatmeal,copos de avena,porridge' },
    { name: 'Batata',             calories: 96,   protein: 1.8,  carbs: 22.2, fat: 0.1,  fiber: 3.3,  serving: 100, searchTerms: 'sweet potato,batata,boniato,camote,papa dulce' },
    { name: 'Papa',               calories: 103,  protein: 2.8,  carbs: 23.3, fat: 0.1,  fiber: 2.4,  serving: 100, searchTerms: 'potato,papa,patata,papas,potato baked' },
    { name: 'Pasta',              calories: 397,  protein: 15.2, carbs: 75.8, fat: 3.3,  fiber: 5.5,  serving: 100, searchTerms: 'pasta,fideos,noodles,macarrones,spaghetti,tallarines' },
    { name: 'Quinoa',             calories: 364,  protein: 13.3, carbs: 66.7, fat: 5.8,  fiber: 8.5,  serving: 100, searchTerms: 'quinoa,quinua' },
    { name: 'Whole Wheat Bread',  calories: 247,  protein: 13,   carbs: 41,   fat: 4.2,  fiber: 6.8,  serving: 100, searchTerms: 'whole wheat bread,pan integral,pan,bread,pan de molde integral' },
    { name: 'White Bread',        calories: 265,  protein: 9,    carbs: 49,   fat: 3.2,  fiber: 2.7,  serving: 100, searchTerms: 'white bread,pan blanco,pan,bread,pan de molde,lactal' },
    // Verduras
    { name: 'Broccoli',           calories: 34,   protein: 2.8,  carbs: 7,    fat: 0.4,  fiber: 2.6,  serving: 100, searchTerms: 'broccoli,brócoli,brocoli,brocol' },
    { name: 'Spinach',            calories: 23,   protein: 2.9,  carbs: 3.6,  fat: 0.4,  fiber: 2.2,  serving: 100, searchTerms: 'spinach,espinaca,espinacas' },
    { name: 'Mixed Salad Greens', calories: 20,   protein: 1.8,  carbs: 3.5,  fat: 0.3,  fiber: 2,    serving: 100, searchTerms: 'salad,ensalada,lechuga,verdes,greens,mixed greens' },
    // Frutas
    { name: 'Banana',             calories: 89,   protein: 1.1,  carbs: 23,   fat: 0.3,  fiber: 2.6,  serving: 100, searchTerms: 'banana,plátano,platano,banano,cambur' },
    { name: 'Apple',              calories: 52,   protein: 0.3,  carbs: 14,   fat: 0.2,  fiber: 2.4,  serving: 100, searchTerms: 'apple,manzana,manzanas' },
    { name: 'Blueberries',        calories: 57,   protein: 0.7,  carbs: 14,   fat: 0.3,  fiber: 2.4,  serving: 100, searchTerms: 'blueberries,arándanos,arandanos,moras azules,berries' },
    // Grasas
    { name: 'Avocado',            calories: 160,  protein: 2,    carbs: 9,    fat: 15,   fiber: 7,    serving: 100, searchTerms: 'avocado,palta,aguacate' },
    { name: 'Almonds',            calories: 579,  protein: 21,   carbs: 22,   fat: 50,   fiber: 12.5, serving: 100, searchTerms: 'almonds,almendras,frutos secos,nuts' },
    { name: 'Peanut Butter',      calories: 588,  protein: 25,   carbs: 20,   fat: 50,   fiber: 6,    serving: 100, searchTerms: 'peanut butter,mantequilla de mani,mantequilla de maní,crema de maní,pasta de maní,maní,peanut' },
    { name: 'Olive Oil',          calories: 884,  protein: 0,    carbs: 0,    fat: 100,  fiber: 0,    serving: 100, searchTerms: 'olive oil,aceite de oliva,aceite,oliva' },
    // Lácteos
    { name: 'Whole Milk',         calories: 61,   protein: 3.2,  carbs: 4.8,  fat: 3.3,  fiber: 0,    serving: 100, searchTerms: 'whole milk,leche entera,leche,milk' },
    { name: 'Cheddar Cheese',     calories: 402,  protein: 25,   carbs: 1.3,  fat: 33,   fiber: 0,    serving: 100, searchTerms: 'cheddar,cheddar cheese,queso cheddar,queso' },
    // Carnes rojas argentinas — raw values
    { name: 'Vacío',              calories: 161,  protein: 21.4, carbs: 0,    fat: 8.1,  fiber: 0,    serving: 100, searchTerms: 'vacio,vacío,beef,carne,asado,flank' },
    { name: 'Picanha',            calories: 220,  protein: 18.5, carbs: 0,    fat: 16,   fiber: 0,    serving: 100, searchTerms: 'picanha,cuadril,beef,carne,rump cap' },
    { name: 'Asado de Tira',      calories: 290,  protein: 17,   carbs: 0,    fat: 25,   fiber: 0,    serving: 100, searchTerms: 'asado,tira de asado,asado de tira,beef,carne,costillas,ribs' },
    { name: 'Costilla',           calories: 270,  protein: 18,   carbs: 0,    fat: 22,   fiber: 0,    serving: 100, searchTerms: 'costilla,costillas,ribs,beef,carne,short ribs' },
    { name: 'Entraña',            calories: 175,  protein: 20,   carbs: 0,    fat: 10.5, fiber: 0,    serving: 100, searchTerms: 'entraña,skirt steak,beef,carne,entrania' },
    { name: 'Colita de Cuadril',  calories: 168,  protein: 21,   carbs: 0,    fat: 9.3,  fiber: 0,    serving: 100, searchTerms: 'colita,cuadril,colita de cuadril,beef,carne,rump' },
    { name: 'Matambre',           calories: 158,  protein: 20.5, carbs: 0,    fat: 8.5,  fiber: 0,    serving: 100, searchTerms: 'matambre,flank steak,beef,carne' },
    // Cerdo — raw values
    { name: 'Bondiola de cerdo',  calories: 215,  protein: 18,   carbs: 0,    fat: 15.8, fiber: 0,    serving: 100, searchTerms: 'bondiola,pork,cerdo,chancho,pork shoulder,bondiola de cerdo' },
    { name: 'Paleta de cerdo',    calories: 185,  protein: 19.5, carbs: 0,    fat: 12,   fiber: 0,    serving: 100, searchTerms: 'paleta,pork shoulder,cerdo,chancho,paleta de cerdo' },
    { name: 'Lomo de cerdo',      calories: 143,  protein: 21,   carbs: 0,    fat: 6.5,  fiber: 0,    serving: 100, searchTerms: 'lomo de cerdo,pork loin,cerdo,chancho,lomo' },
    // Fiambres y embutidos
    { name: 'Chorizo crudo',      calories: 295,  protein: 14,   carbs: 1,    fat: 26,   fiber: 0,    serving: 100, searchTerms: 'chorizo,sausage,embutido,chorizo crudo' },
    { name: 'Panceta',            calories: 403,  protein: 13,   carbs: 0,    fat: 39,   fiber: 0,    serving: 100, searchTerms: 'panceta,bacon,pancita,cerdo,panceta ahumada' },
    { name: 'Morcilla',           calories: 315,  protein: 12,   carbs: 3,    fat: 28,   fiber: 0,    serving: 100, searchTerms: 'morcilla,blood sausage,embutido' },
    { name: 'Salame',             calories: 358,  protein: 22,   carbs: 2,    fat: 29,   fiber: 0,    serving: 100, searchTerms: 'salame,salami,embutido,fiambre' },
    { name: 'Pepperoni',          calories: 494,  protein: 20,   carbs: 2,    fat: 45,   fiber: 0,    serving: 100, searchTerms: 'pepperoni,salami,embutido' },
    { name: 'Chorizo colorado',   calories: 380,  protein: 20,   carbs: 3,    fat: 32,   fiber: 0,    serving: 100, searchTerms: 'chorizo colorado,chorizo,embutido' },
    { name: 'Mortadela',          calories: 280,  protein: 14,   carbs: 3,    fat: 23.5, fiber: 0,    serving: 100, searchTerms: 'mortadela,mortadella,embutido,fiambre' },
    // Quesos
    { name: 'Queso cremoso',      calories: 290,  protein: 16,   carbs: 2,    fat: 24,   fiber: 0,    serving: 100, searchTerms: 'queso cremoso,cream cheese,queso,cremoso' },
    { name: 'Queso pategrás',     calories: 370,  protein: 26,   carbs: 0,    fat: 29,   fiber: 0,    serving: 100, searchTerms: 'pategrás,pategras,queso,queso pategrás' },
    { name: 'Queso mozzarella',   calories: 280,  protein: 22,   carbs: 2,    fat: 20.5, fiber: 0,    serving: 100, searchTerms: 'mozzarella,queso mozzarella,queso,mozarella' },
    { name: 'Queso provolone',    calories: 352,  protein: 26,   carbs: 2,    fat: 27,   fiber: 0,    serving: 100, searchTerms: 'provolone,queso provolone,queso,provoleta' },
    { name: 'Queso parmesano',    calories: 431,  protein: 38,   carbs: 4,    fat: 29,   fiber: 0,    serving: 100, searchTerms: 'parmesano,parmesan,queso parmesano,queso,parmigiano' },
    // Snacks y dulces
    { name: 'Chocolate negro 70%', calories: 598, protein: 8,   carbs: 46,   fat: 43,   fiber: 10,   serving: 100, searchTerms: 'chocolate negro,dark chocolate,chocolate,cacao' },
    { name: 'Chocolate con leche', calories: 535, protein: 7,   carbs: 57,   fat: 31,   fiber: 2,    serving: 100, searchTerms: 'chocolate con leche,milk chocolate,chocolate' },
    { name: 'Dulce de leche',      calories: 321, protein: 7,   carbs: 55,   fat: 8,    fiber: 0,    serving: 100, searchTerms: 'dulce de leche,caramel,dulce,ddl' },
    { name: 'Alfajor de maicena',  calories: 390, protein: 5,   carbs: 64,   fat: 13,   fiber: 1,    serving: 100, searchTerms: 'alfajor,cookie,galleta,alfajor de maicena' },
    { name: 'Galletitas de arroz', calories: 387, protein: 8,   carbs: 82,   fat: 3,    fiber: 1,    serving: 100, searchTerms: 'galletitas de arroz,rice cakes,arroz,rice crackers' },
    { name: 'Maní con chocolate',  calories: 478, protein: 11,  carbs: 50,   fat: 26,   fiber: 3,    serving: 100, searchTerms: 'maní,peanut,chocolate,maní con chocolate,peanuts' },
    { name: 'Granola',             calories: 476, protein: 10,  carbs: 64,   fat: 20,   fiber: 5,    serving: 100, searchTerms: 'granola,cereal,avena,muesli' },
    { name: 'Turrón',              calories: 394, protein: 8,   carbs: 68,   fat: 10,   fiber: 2,    serving: 100, searchTerms: 'turron,turrón,nougat,almendras' },
    // Bebidas
    { name: 'Cerveza rubia lager',     calories: 43,  protein: 0.5, carbs: 3.5,  fat: 0,   fiber: 0,   serving: 100, searchTerms: 'cerveza,beer,lager,birra,rubia' },
    { name: 'Cerveza negra stout',     calories: 53,  protein: 0.5, carbs: 5,    fat: 0,   fiber: 0,   serving: 100, searchTerms: 'cerveza,beer,stout,birra,negra' },
    { name: 'Vino tinto',              calories: 85,  protein: 0.1, carbs: 2.6,  fat: 0,   fiber: 0,   serving: 100, searchTerms: 'vino,wine,vino tinto,red wine,tinto' },
    { name: 'Vino blanco',             calories: 82,  protein: 0.1, carbs: 2.7,  fat: 0,   fiber: 0,   serving: 100, searchTerms: 'vino,wine,vino blanco,white wine,blanco' },
    { name: 'Fernet',                  calories: 220, protein: 0,   carbs: 16,   fat: 0,   fiber: 0,   serving: 100, searchTerms: 'fernet,fernet branca,amargo' },
    { name: 'Coca Cola',               calories: 42,  protein: 0,   carbs: 10.6, fat: 0,   fiber: 0,   serving: 100, searchTerms: 'coca cola,coca,coke,cola,refresco,soda,gaseosa' },
    { name: 'Coca Cola Zero',          calories: 0.4, protein: 0,   carbs: 0.1,  fat: 0,   fiber: 0,   serving: 100, searchTerms: 'coca zero,coca cola zero,coke zero,gaseosa,refresco,zero' },
    { name: 'Jugo de naranja natural', calories: 45,  protein: 0.7, carbs: 10.4, fat: 0.2, fiber: 0.2, serving: 100, searchTerms: 'jugo,orange juice,naranja,jugo de naranja,jugo natural' },
    { name: 'Gatorade',                calories: 26,  protein: 0,   carbs: 6.5,  fat: 0,   fiber: 0,   serving: 100, searchTerms: 'gatorade,isotonica,sports drink,isotónica,bebida deportiva' },
    { name: 'Monster Energy',          calories: 46,  protein: 0.5, carbs: 11,   fat: 0,   fiber: 0,   serving: 100, searchTerms: 'monster,energy drink,bebida energizante' },
    // Condimentos
    { name: 'Mayonesa',          calories: 680,  protein: 1,   carbs: 1,  fat: 74.5, fiber: 0,   serving: 100, searchTerms: 'mayonesa,mayonnaise,mayo' },
    { name: 'Ketchup',           calories: 102,  protein: 1.5, carbs: 24, fat: 0.1,  fiber: 0.5, serving: 100, searchTerms: 'ketchup,catsup,salsa de tomate,ketchu' },
    { name: 'Mostaza',           calories: 63,   protein: 4,   carbs: 5,  fat: 3,    fiber: 2,   serving: 100, searchTerms: 'mostaza,mustard' },
    { name: 'Salsa de soja',     calories: 52,   protein: 8,   carbs: 5,  fat: 0,    fiber: 0,   serving: 100, searchTerms: 'salsa de soja,soy sauce,soja,soya sauce' },
    { name: 'Salsa de tomate',   calories: 29,   protein: 1.5, carbs: 5,  fat: 0.3,  fiber: 1,   serving: 100, searchTerms: 'salsa de tomate,tomato sauce,tomate,passata' },
    { name: 'Chimichurri',       calories: 352,  protein: 2,   carbs: 5,  fat: 36,   fiber: 1,   serving: 100, searchTerms: 'chimichurri,sauce,salsa,chimichurri argentino' },
    { name: 'Aceite de girasol', calories: 884,  protein: 0,   carbs: 0,  fat: 100,  fiber: 0,   serving: 100, searchTerms: 'aceite de girasol,sunflower oil,aceite,girasol' },
  ];
